...
def enable_autoclicker():
   ...
   if buyed:
     ...
     autoclicker_cost.config(text = "Disattiva", command = disable_autoclicker, font = ("consolas", 6))
     refresh_shop(coins, click_multiplier)
     refresh_stats(coin_multiplier, click_multiplier, aclick_speed)
...
def disable_autoclicker():
   ...
   autoclicker_cost.config(text = "Attiva", command = enable_autoclicker, font = ("consolas", 10))
   refresh_shop(coins, click_multiplier)
   refresh_stats(coin_multiplier, click_multiplier, aclick_speed)
